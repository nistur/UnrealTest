...
UnrealTestRootPath=/home/nistur/Documents/Unreal Projects/UnrealTest

gameProjectFile=/home/nistur/Documents/Unreal Projects/UnrealTest/UnrealTest.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(UnrealTestSource.pri)
include(UnrealTestHeader.pri)
include(UnrealTestConfig.pri)
include(UnrealTestIncludes.pri)
include(UnrealTestDefines.pri)
...
UnrealTest-Linux-Debug.commands = $$build UnrealTest Linux Debug  -project="\"$$gameProjectFile\"" $$args
UnrealTest-Linux-DebugGame.commands = $$build UnrealTest Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
UnrealTest-Linux-Shipping.commands = $$build UnrealTest Linux Shipping  -project="\"$$gameProjectFile\"" $$args
UnrealTest-Linux-Test.commands = $$build UnrealTest Linux Test  -project="\"$$gameProjectFile\"" $$args
UnrealTest.commands = $$build UnrealTest Linux Development  -project="\"$$gameProjectFile\"" $$args

UnrealTestEditor-Linux-Debug.commands = $$build UnrealTestEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
UnrealTestEditor-Linux-DebugGame.commands = $$build UnrealTestEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
UnrealTestEditor-Linux-Shipping.commands = $$build UnrealTestEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
UnrealTestEditor-Linux-Test.commands = $$build UnrealTestEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
UnrealTestEditor.commands = $$build UnrealTestEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	UnrealTest-Linux-Debug \
	UnrealTest-Linux-DebugGame \
	UnrealTest-Linux-Shipping \
	UnrealTest-Linux-Test \
	UnrealTest \
	UnrealTestEditor-Linux-Debug \
	UnrealTestEditor-Linux-DebugGame \
	UnrealTestEditor-Linux-Shipping \
	UnrealTestEditor-Linux-Test \
	UnrealTestEditor \

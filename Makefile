...
UnrealTest-Linux-Debug:
	 $(PROJECTBUILD) UnrealTest Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealTest-Linux-DebugGame:
	 $(PROJECTBUILD) UnrealTest Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealTest-Linux-Shipping:
	 $(PROJECTBUILD) UnrealTest Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealTest-Linux-Test:
	 $(PROJECTBUILD) UnrealTest Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealTest:
	 $(PROJECTBUILD) UnrealTest Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealTestEditor-Linux-Debug:
	 $(PROJECTBUILD) UnrealTestEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealTestEditor-Linux-DebugGame:
	 $(PROJECTBUILD) UnrealTestEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealTestEditor-Linux-Shipping:
	 $(PROJECTBUILD) UnrealTestEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealTestEditor-Linux-Test:
	 $(PROJECTBUILD) UnrealTestEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

UnrealTestEditor:
	 $(PROJECTBUILD) UnrealTestEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
